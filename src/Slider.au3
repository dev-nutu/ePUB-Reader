...
Func CreateSlider($hGUI, $iX, $iY, $iWidth, $iHeight, $aColors)
    ...
    $mSlider['Config'] = GUICtrlCreateButton('', $iX + $mSlider['W'] - $mSlider['ElementHeigth'] + 1, $iY + $mSlider['ElementHeigth'] + 1, $mSlider['ElementHeigth'] - 2, $mSlider['ElementHeigth'] - 2, 0x0380)
    $mSlider['Jump'] = GUICtrlCreateButton('', $iX + $mSlider['W'] - $mSlider['ElementHeigth'] * 2 + 2, $iY + $mSlider['ElementHeigth'] + 1, $mSlider['ElementHeigth'] - 2, $mSlider['ElementHeigth'] - 2, 0x0380)
